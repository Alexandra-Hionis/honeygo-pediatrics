...
class Footer extends HTMLElement {
  connectedCallback() {
    ...
    <footer class="footer gradient-gray">
      ...
      <div class="footer-top-portion">
        ...
        <div class="footer-item-container"><div class="footer-item">
          ...
          <div class="footer-content footer-content-hours">
              ...
              <p class="hours-disclaimer"><strong>Walk in hours for sick patients <br> 9 AM - 11 AM and 1 PM - 2:30 PM Monday - Friday<br>9 AM - 10:30 AM Saturdays</strong></p>
            </div>
            </div>
          </div>
      ...
      <div class="footer-bottom-section copyright">&copy; <span id="copyright-year"></span> Honeygo Pediatrics LLC </div>
      <div class="footer-bottom-section copyright">
      <p>Designed and Developed by</p>
      <a href="https://alexandra-hionis-portfolio.herokuapp.com/" target="_blank"> Alexandra Hionis</a>
      </div>
      </footer>
  </section>
        `;
